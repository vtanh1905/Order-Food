    ...
    return (
      <Layout className="layout">
        <div className="d-flex flex-column justify-content-between">
          <Navbar className="shadow" variant="dark" bg="dark" expand="lg" style={{ zIndex: 3 }}>
            <Navbar.Brand href="/">
              <img
          ...
          <Footer style={{ textAlign: 'center', padding: 'unset', zIndex: 999 }}>
            <div style={{ background: '#585656', height: 350, color: 'white', padding: 50 }}>
              <Row>
                <Col span={6} style={{ textAlign: 'left' }}>
                  ...
                  <div>
                    <Icon type="phone" />
                    <p style={{ fontSize: 18, color: 'white', marginLeft: 10, display: 'inline' }}>+84 962 074 802</p>
                  </div>
                  <div>
                    <Icon type="mail" />
                    <p style={{ fontSize: 18, color: 'white', marginLeft: 10, display: 'inline' }}>admin@lunchapp.com</p>
                  </div>
                </Col>
                <Col span={6} style={{ textAlign: 'left' }}>
                  <p style={{ fontSize: 25, color: 'orange' }}>Thông tin</p>
                  <Link style={{ fontSize: 18, color: 'white' }} to="/about"> <p>Về chúng tôi</p> </Link>
                  <Link style={{ fontSize: 18, color: 'white' }} to="/about"> <p>FAQ</p> </Link>
                  <Link style={{ fontSize: 18, color: 'white' }} to="/about"> <p>Thông tin thêm</p> </Link>
                  <Link style={{ fontSize: 18, color: 'white' }} to="/about"> <p>Công nghệ</p> </Link>
                </Col>
                <Col span={6} style={{ textAlign: 'left' }}>
                  <p style={{ fontSize: 25, color: 'orange' }}>Đường dây nóng</p>
                  <p style={{ fontSize: 18, color: 'white' }}>Dịch vụ</p>
                  <p style={{ fontSize: 18, color: 'white' }}>Hỗ trợ</p>
                  <p style={{ fontSize: 18, color: 'white' }}>Điều khoản và điều kiện</p>
                  <p style={{ fontSize: 18, color: 'white' }}>Các chính sách</p>
                </Col>
                <Col span={6} style={{ textAlign: 'left' }}>
                  <div style={{ marginBottom: 20 }}>
                    <Icon style={{ fontSize: '25px', marginRight: 10 }} type="mail" />
                    <p style={{ fontSize: 18, color: 'white', marginLeft: 10, display: 'inline' }}>Nhận các thông tin liên quan đến Luch App</p>
                  </div>
                  <Form>
