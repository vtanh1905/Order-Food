...
class Home extends React.Component {
    ...
    this.state = {
      foods: [
        ...
        },
        {
          ...
          name: "Bún thịt nướng",
          description:
            "Bún ăn với thịt nướng cùng nước mắm và rau sống kiểu Huế.",
          type: "MAIN",
          options: [
            {
              id: 1,
        ...
        },
        {
          id: 8,
          src:
            "https://wikiohana.net/wp-content/uploads/2019/01/bun-dau-mam-tom.jpg",
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if (
          (tab === "MAIN" && numberMain > 0) ||
          (tab === "DESSERT" && numberDessert > 0)
        ) {
  ...
  handleRemoveItem = id => {
    ...
    this.setState({
      ordered: this.state.ordered.filter(el => el.id !== id),
      numberMain,
      numberDessert
    });
  };
  ...
  handleSubmitFood = () => {
    this.setState({ ordered: [] }, () => {
      this.openNotificationWithIcon(
        "success",
        "The Foods have been ordered Sucessfully!"
      );
    });
  };
    ...
    return (
      <LayoutHeader>
        ...
        >
          ...
          >
            <h3 className="order-title">Các món đã chọn:</h3>
            <Divider></Divider>
            <List
                        ...
                        item.type === "MAIN" ? (
                          <div style={{ width: "100%" }}>
                            ...
                            <Col span={24} offset={0}>
                              <h5 style={{ color: "#191970" }}>{item.title}</h5>
                            </Col>
                          </div>
                        ) : (
                          <div>
            ...
            {ordered.length > 0 && (
              <Button
                ...
                className="btn-datmon login-form-button "
              >
                Submit
              </Button>
            )}
          ...
          <Content style={{ padding: "0 24px", minHeight: 280 }}>
            <Tabs activeKey={this.state.tab} onChange={this.handleTabChange}>
              <TabPane
                tab={
                  <Badge
                    count={this.state.numberMain}
                    showZero
                    style={{
                      backgroundColor:
                        this.state.numberMain > 0 ? "#52c41a" : "red"
                    }}
                  >
                    <div style={{ display: "flex", flexDirection: "row" }}>
                      ...
                      <i
                        ...
                        style={{ marginTop: 7, fontSize: 20, marginRight: 8 }}
                      ></i>
              ...
              <TabPane
                tab={
                  <Badge
                    count={this.state.numberDessert}
                    showZero
                    style={{
                      backgroundColor:
                        this.state.numberDessert > 0 ? "#52c41a" : "red"
                    }}
                  >
                    <div className="d-flex align-items-center">
                      <Icon
                        style={{ marginTop: 7, fontSize: 20 }}
                        type="coffee"
                      />
          ...
          {visible && clickID !== -1 && (
            <Layout style={{ background: "white" }}>
              <Form onSubmit={this.handleSubmit}>
                ...
                <Row>
                  {foods[clickID - 1].options.map(el => (
                    <Col key={el.id} style={{ marginTop: 10 }}>
                ...
                <Row>
                  {getFieldDecorator("note", {})(<Input.TextArea rows={4} />)}
                </Row>
